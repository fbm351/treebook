...
class UserFriendshipsControllerTest < ActionController::TestCase
    context "#index" do
        ...
        context "When logged in" do
            setup do
                @friendship1 = create(:pending_user_friendship, user: users(:fred), friend: create(:user, first_name: 'Pending', last_name: 'Friend'))
                @friendship2 = create(:accepted_user_friendship, user: users(:fred), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
            ...
            should "assign user friendships to an instance variable" do
    ...
    context "#create" do
        ...
        context "when logged in" do
            ...
            context "successfully" do
                should "create 2 user friendship objects" do
